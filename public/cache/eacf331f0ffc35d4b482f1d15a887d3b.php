...
<html lang="zh-CN">
  ...
  <div id="wrap">
    ...
    <div id="container">
      <div id="main">
        <div class="container-fluid item-left">
          <?php for ($j = 0; $j < $atcnum; $j++):?>
          <section class="post">
            <a href="index.php?m=artail&id=<?=$id[$j]; ?>">
              <div class="panel panel-default">
                <div class="panel-heading">
                  <h3 class="panel-title title"><?=$title[$j]; ?><span class="usr"><?=$username[$j]; ?></span></h3>
                </div>
                <div class="panel-body">
                  <?=$overview[$j]; ?>
                  <time class="pub-time"><?=$wrtime[$j]; ?></time>
                </div>
              </div>
            </a>
          </section>
          ...
          <nav aria-label="...">
            <ul class="pager page">
              <a href="<?=$first; ?>" class="first"><i class="glyphicon glyphicon-chevron-up"></i> 首页</a>
              <li><a href="<?=$prev; ?>">上一页</a></li>
              <li><a href="<?=$next; ?>">下一页</a></li>
              <a href="<?=$end; ?>" class="last"><i class="glyphicon glyphicon-chevron-down"></i> 尾页</a>
            </ul>
          </nav>
        </div>
      </div>
      <div id="asidepart">
        ...
        <div class="container-fluid">
          <div class="hero-unit">
            ...
            <div class="hero-wrap">
            <span class="label label-default"><a href="">手机</a></span>
            <span class="label label-default"><a href="">互联网</a></span>
            <span class="label label-default"><a href="">诗歌</a></span>
            </div>
          </div>
        </div>
        <div class="container-fluid">
