    ...
    <div id="container">
      <div class="container">
        <div class="panel panel-default about-text atc-panel">
          <form action="index.php?m=addatc&a=add" method="post">
            <div class="input-group">
              <span class="input-group-addon" id="sizing-addon2">标题</span>
              <input type="text" class="form-control" placeholder="" aria-describedby="sizing-addon2" name="title" value="<?=$title; ?>">
            </div>
            <textarea name="text" id="atc-text" cols="30" rows="10" placeholder="在这里写下你的创意吧...">
              <?=$text; ?>
            </textarea>
            <button class="btn btn-default" id="atc-btn">确定</button>
          </form>
        </div>
      </div>
    </div>
